...
public class GUI extends JFrame {
			...
			public void actionPerformed(ActionEvent e) {
				...
				if (checkColor(curColor) == true) {
					...
					for (int i = 0; i < bikeList.size(); i++) {
						textArea.append(bikeList.get(i).getColor() + " " + bikeList.get(i).getSize() + " "
	...
	/**
	 * Kollar om priset är för stort eller litet, ändrar det till ett bättre
	 * värde
	 */
	...
	/**
	 * Kollar om storleken är för stor eller liten, ändrar den till ett bättre
	 * värde
	 */
